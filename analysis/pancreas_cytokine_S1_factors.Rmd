...
+ topic 1: $\beta$ cells (*Ins1*, *Ins2*, *Mafa*)
+ topic 3: duct cells (*Krt19*)
+ topic 4: macrophages (*Ccr5*)
+ topic 5: $\alpha$ (*Gcg*, *Mafb*) and $\gamma$ cells (*Ppy*)
+ topic 6: replicate effect
+ topic 9: endothelial cells (*Pecam1*, *Esam*)
+ topic 10: mesenchymal cells (*Col1a1*)
+ topic 13: $\delta$ cells (*Sst*)
...
Factor 12 appears to be capturing cell cycle:
