...
+ topic 4: $\beta$ cells (*Ins1*, *Ins2*, *Mafa*)
+ topic 7: *Ins1-* $\beta$ cells?
+ topic 3: $\alpha$, $\delta$ and $\gamma$ cells
+ topic 5: macrophages (*Ccr5*)
+ topic 2: endothelial cells (*Pecam1*, *Esam*)
+ topic 6: mesenchymal cells (*Col1a1*)
