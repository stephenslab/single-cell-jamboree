...
TO DO: Use MatrixExtra::mapSparse to compute the shifted log counts.
...
TO DISCUSS: Is the topic model capturing mostly "cluster-like" structure.
...
TO DO: Replace correlation with cosine similarity (first double-check
...
TO DO: Are the topics more "cluster-like" than the flashier factors?
