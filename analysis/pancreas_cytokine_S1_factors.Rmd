...
tm_k13 <- fit_poisson_nmf(counts,k = 13,init.method = "random",method = "em",
                          numiter = 40,verbose = "none",
                          control = list(numiter=4,nc=8,extrapolate=FALSE))
tm_k13 <- fit_poisson_nmf(counts,fit0 = tm_k13,method = "scd",numiter = 40,
                          control = list(numiter=4,nc=8,extrapolate=TRUE),
						  verbose = "none")
```
...
structure_plot(tm_k13,grouping = clusters,gap = 10)
```
