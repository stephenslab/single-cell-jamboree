...
```{r topics-vs-factors, fig.height=4, fig.width=6}
...
+ Show that the topics and factors are "cluster-like" in that they are
  strongly correlated with each other, but less so for the factors.

+ Check whether one of the factors (e.g., k7, k8, k12) could
  be a "baseline" factor for pancreas cells?
...
+ Identify "distinctive" genes using de_analysis for topic model
  and with a custom function from the singlecelljamboreeR package
  for the factors.
