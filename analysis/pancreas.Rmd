...
[Luecken et al 2022 benchmarking paper][luecken-2022].  Used in
several previous papers benchmark data integration methods (otherwise
known as "batch correction" or "harmonization" methods)
[the Supplementary Note gives references; e.g., the [MNN paper][mnn-paper]]. See
Supplementary Fig. 13, Supplementary Note 3 andSupplementary Data 7
for more info on this data set.
