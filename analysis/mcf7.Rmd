...
```{r gene-matrix-scatterplots-topic-model, fig.height=2.25, fig.width=6, warning=FALSE}
...
```{r gene-matrix-scatterplot, fig.height=2.25, fig.width=6}
...
```{r nmf-vs-tm, fig.height=2.25, fig.width=6}
...
```{r gene-matrix-scatterplot-topic-model-k4, fig.height=2.25, fig.width=6}
