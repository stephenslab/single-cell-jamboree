...
that is is picked up by the Poisson-based methods but not by the
Gaussian-based methods, so to avoid this complication in the
comparisons I have removed these genes from the data, which aren't of
interest anyhow.)
...
TO DO NEXT: Add flashier result.
