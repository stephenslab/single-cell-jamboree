...
```{r structure-plots-tissues, fig.height=5.5, fig.width=7.5, results="hide", message=FALSE}
topics_tissue <- c("k2","k3","k9","k12","k14","k15")
topic_colors <-
...
Specific to organoids:

```{r structure-plots-organoids, fig.height=5.5, fig.width=7.5, results="hide", message=FALSE}
topics_organoid <- c("k4","k6","k8","k11","k13","k16")
rows1 <- which(sample_info$origin == "Tissue")
rows2 <- which(sample_info$origin == "Org")
...
```{r structure-plots-shared, fig.height=5.5, fig.width=7.5, results="hide", message=FALSE}
