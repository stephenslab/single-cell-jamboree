...
Fit a topic model with $K = 9$ topics to the counts:
...
p <- structure_plot(tm_k9,grouping = samples$tissue,gap = 4,
...
TO DO: Also run flashier with a smaller number of factors.
