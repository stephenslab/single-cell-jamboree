...
- The factor $k7$ (and $k15$) is unique to White Blood Cells.
...
- Factor $k12$ is unique to Chondrocytes (also appears in Connective Tissue Progenitors).
...
## More detailed explored of NN-EBMF
...
```{r}
factor_of_interest <- c(2, 3, 5, 7, 9, 10)
...
For the factor `k7` that is almost unique to white blood cells, the leading gene is ENSMUSG00000002985.
This gene corresponds to the Apolipoprotein E (Apoe) gene in Mus musculus (mouse).
There seems to be some literature that relates Apoe to white blood cells, but still is kind of suprising to see this gene is the leading gene for this factor.
