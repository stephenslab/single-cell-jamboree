...
structure_plot(L,grouping = topics,gap = 10,topics = newsgroups_topics)
```

while a others appear to be capturing different trends,

```{r structure-plot-2, fig.height=2.2, fig.width=7, results="hide", message=FALSE}
other_topics <- paste0("k",c(2,4))
structure_plot(L,grouping = topics,gap = 10,topics = other_topics)
```

(Topic 2, while appearing in many different newsgroups, shows up much
more in the rec.motorcycles newsgroup. So it may be capturing
motorcycle-related discussion.)
