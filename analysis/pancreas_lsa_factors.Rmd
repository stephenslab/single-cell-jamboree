...
```{r structure-plots-flashier-by-cell-type, fig.height=4.5, fig.width=7.5, results="hide", message=FALSE, eval=FALSE}
set.seed(1)
...
```{r treatment-factors-box-plots, fig.height=2.25, fig.width=4}
L <- fl_nmf_ldf$L
colnames(L) <- paste0("k",1:13)
